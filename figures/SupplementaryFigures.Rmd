...
tops <- imm_raref %>% 
  ...
  mutate(Size=ifelse(PatientID!="LN0217", Size+6, Size)) 
...
#ggsave(filename = "Figure7_p2.pdf", width = 13, height = 4.25, units = "cm")
...
p_full
#ggsave(p_full, width = 19, height = 14, units = "cm", filename = "SF3.pdf")
...
#ggsave(wrap_plots(plots_codex), width = 19, height = 12.5, units = "cm", filename = "Figure7_p2.pdf")
...
#ggsave(width = 4, height = 4, units = "cm", filename = "Figure7_p2_legend.pdf")
...
#ggsave(p_full, width = 19, height = 11.5, units = "cm", filename = "SF10.pdf")

```

### Legend
```{r legend SF8, fig.height=1}
...
#ggsave(width = 19, height = 1.5, units = "cm", filename = "SF10_legend.pdf")
