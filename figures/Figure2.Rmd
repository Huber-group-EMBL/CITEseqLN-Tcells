...
cor_plots_facs[["TPR"]] <- df_cor %>% 
  ...
  stat_cor(aes(label=..r.label..), method = "pearson",size=2.25, label.x.npc = c(0.4), label.y.npc = c(0.1))+
...
#ggsave(width = 19, height = 7, units = "cm", filename = "Figure2_p2.pdf")
...
FetchData(Combined_T, vars = c("integratedadt_.CD366", "integratedadt_.CD279", "IdentI")) %>% 
  ...
  theme(axis.text = element_text(color="white"),
        ...
        axis.title.x = element_text(vjust = 7, size=7),
        axis.title.y = element_text(vjust = -5, size=7),
        axis.ticks.x =  element_blank(),
